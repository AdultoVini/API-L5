...
<head>
    ...
    <meta charset="UTF-8">
    <title>API</title>
    <meta name="description" content="Prova Técnica L5 Networks">
...
<section>
    ...
    <pre><code>(GET) | /clientes => Retorna todos os clientes cadastrados.</code></pre>
    <pre><code>(GET) | /clientes/1 => Retorna os dados do cliente.</code></pre>
    <pre><code>(POST) | /clientes => Cadastra os dados de um cliente.</code></pre>
    <pre><code>(PUT) | /clientes/1 => Atualiza os dados de um cliente.</code></pre>
    <pre><code>(DELETE) | /clientes/1 => Deleta os dados de um cliente.</code></pre>

    <p>Produtos</p>

    <pre><code>(GET) | /produtos => Retorna todos os produtos cadastrados.</code></pre>
    <pre><code>(GET) | /produtos/1 => Retorna os dados do produto.</code></pre>
    <pre><code>(POST) | /produtos => Cadastra os dados de um produto.</code></pre>
    <pre><code>(PUT) | /produtos/1 => Atualiza os dados de um produto.</code></pre>
    <pre><code>(DELETE) | /produtos/1 => Deleta os dados de um produto.</code></pre>

    <p>Pedidos de Compra</p>

    <pre><code>(GET) | /pedidos => Retorna todos os pedidos de compra cadastrados.</code></pre>
    <pre><code>(GET) | /pedidos/1 => Retorna os dados de um pedido.</code></pre>
    <pre><code>(POST) | /pedidos => Cadastra um novo pedido.</code></pre>
    <pre><code>(PUT) | /pedidos/1 => Atualiza os dados de um pedido.</code></pre>
    <pre><code>(DELETE) | /pedidos/1 => Deleta os dados de um pedido.</code></pre>
